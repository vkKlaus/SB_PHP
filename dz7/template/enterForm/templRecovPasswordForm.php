<form method="POST" class="enter-form">
    ...
    <input name="password_1" type="password" value="<?= $password_1 ?>" id="password-id-1" class="enter-field" />

    <label class="enter-label" for="password-id-2">повторите пароль:</label>

    <input name="password_2" type="password" value="<?= $password_2 ?>" id="password-id-2" class="enter-field" />
